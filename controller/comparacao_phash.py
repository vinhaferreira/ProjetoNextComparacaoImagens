...
hash = imagehash.average_hash(Image.open(r'C:\Users\Gustavo\Desktop\projetoNEXT\Phash\images/1.png'),hash_size= 10)
print ('Imagem 1: ' + str(hash))

#Criando número Hash da segunda imagem
otherhash = imagehash.average_hash(Image.open(r'C:\Users\Gustavo\Desktop\projetoNEXT\Phash\images/2.png'),hash_size= 10)
